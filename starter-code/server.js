...
const app = express();
const conString = 'postgres://@localhost:5432/demo';// DONE: Don't forget to set your own conString
...
app.put('/articles/:id', function(request, response) {
  ...
  .then(function() {
    ...
    client.query(
      ...
      WHERE article_id = $6;`,
      [request.body.author_id, request.body.title, request.body.category, request.body.publishedOn, request.body.body, request.param.id]
    );
  })
  .then(function() {
